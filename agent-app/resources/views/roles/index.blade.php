...
<!-- Floating Labels Form -->
            <form class="row g-3" action="{{route('rolestore')}}" method="post">
                @csrf 
                @method('post')
                <div class="">
                  <div class="form-floating">
                    <input type="text" class="form-control" name="libele" id="floatingPassword" placeholder="role" required>
                    <label for="floatingPassword">Libele Role</label>
                  </div>
                </div>
