    ...
    <!-- <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <div class="flex items-center">
                ...
                <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Departement</a>
            </div>
            </li>
        ...
        <div class="grid grid-cols-1 gap-4 mb-4 sm:grid-cols-1 lg:grid-cols-3 md:grid-cols-2">
            <div class="flex items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-800">
                <span class="text-2xl text-gray-400 dark:text-gray-500">
                    <a href="{{route('departement-dossier.index')}}">
