    ...
    @if(session('success'))
                    <div id="alert-3" class="flex items-center p-4 mb-4 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
                        ...
                        <div class="ms-3 text-sm font-medium">
                            <label class="font-semibold ">{{session('success')}}</label>
                        </div>
            ...
            @if(session('echec'))
                ...
                <div id="alert-2" class="flex items-center p-4 mb-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                    ...
                    <span class="sr-only">Info</span>
                    <div class="center ms-3 text-sm font-medium flex items-center text-center">
                        <label class="center font-medium items-center text-center align-center">Erreur </label> {{session('echec')}}
                    </div>
        ...
        <tbody>
            @foreach($presence as $k=>$v)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4">
                        <form action="{{route('presences.update',$v->id)}}" method="post">
                            @method('put')
                            @csrf
