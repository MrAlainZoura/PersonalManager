        ...
        <main class="mt-30">
            <div class="mt-10 py-10 ">
                ...
                <div class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                   Gérer la présence de vos collaborateurs en seul clic<!-- . <a href="#" class="font-semibold text-indigo-600"><span class="absolute inset-0" aria-hidden="true"></span>Plus d'information<span aria-hidden="true">&rarr;</span></a>-->
                </div> 
                </div>
                ...
                <div class="mt-10 flex items-center justify-center gap-x-6">
                    <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Vous êtes dans le portail de présence<span aria-hidden="true">→</span></a>
                </div>
                </div>
            </div>
            <!-- fin banner -->
            ...
            <section class="bg-gradient-to-r from-gray-100 via-white-100 to-blue-100  dark:bg-gray-900">
                <div class="container mx-auto px-6 py-10">
                    <div class="text-center">
                        ...
                        <p class="mx-auto mt-4 max-w-lg text-dark">En dehors de la présence, vous avez les récentes informations de l'entreprise</p>
                    </div>
                    ...
                    <div class="mt-8 grid grid-cols-1 gap-8 md:mt-16 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                        ...
                        <div class="w-full">
                            ...
                            <h5 class="mb-2 text-md font-bold tracking-tight text-gray-900 dark:text-white">Concerne {{$v->concerne}}</h5>
            ...
            <div class="hidden m-10 grid grid-cols-1  sm:grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-5" >
                <div> 
                ...
                <div class="container mx-auto flex min-h-screen flex-col px-6 py-6">
                    <div class="grid grid-cols-1 gap-10 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1">
                        <div class="text-dark mt-8 lg:mx-6 lg:w-1/2 shadow-2xl">
                            <!-- <h1 class="text-3xl font-semibold capitalize lg:text-5xl">Mes coordonnées</h1>

                            <p class="mt-6 max-w-xl"></p>

                            <div class="mt-6 space-y-8 md:mt-8" id="cordonne">
                                <p class="-mx-2 flex items-start">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="mx-2 h-6 w-6 text-dark" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                    </svg>

                                    <span class="mx-2 w-72  text-dark">4252, URBANISME Q/NDOLO, C/BARUMBU – KINSHASA.
                                    </span>
                                </p>
                                ...
                                <p class="-mx-2 flex items-start">
                                    ...
                                    <span class="mx-2 w-72 truncate text-dark">+243 85 19 14 242</span>
                                </p>
                                ...
                                <p class="-mx-2 flex items-start">
                                    ...
                                    <span class="mx-2 w-72 truncate text-dark"><a href="mailto:chloemitewu@gmail.com">chloemitewu@gmail.com</a> </span>
                                </p>
                            </div> -->
                        ...
                        <div class="mt-8 lg:mx-6 lg:w-1/2">
                            <div class="mx-auto w-full overflow-hidden rounded-xl bg-white px-8 py-10 shadow-2xl dark:bg-gray-900 lg:max-w-xl">
                                ...
                                <form class="mt-6" method="post" action="{{route('home.login')}}">
                                    @csrf 
                                    @method('post')
